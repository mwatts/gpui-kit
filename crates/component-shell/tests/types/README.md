...
The compile-only `custom-children.ts` fixture checks retained entities and scalar children alongside fluent component builders. It also checks both callable and constructible input and scrollbar state factories.
